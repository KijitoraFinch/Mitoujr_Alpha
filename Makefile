.PHONY: phase0-check contract-test golden-check build-sugar test-sugar distribution-check check-bitter opam-lint check release-check
...
check: phase0-check contract-test golden-check build-sugar test-sugar distribution-check check-bitter
